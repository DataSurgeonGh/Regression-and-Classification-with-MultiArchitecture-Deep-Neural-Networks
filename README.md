...
## Getting Started
1. git clone https://github.com/DataSurgeonGh/Regression-and-Classification-with-MultiArchitecture-Deep-Neural-Networks.git
...
3. conda create -n r-tensorflow python=3.10
...
### Render the document
5. quarto render DNN_project1.qmd
